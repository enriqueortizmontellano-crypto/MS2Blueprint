...
const IB4_UWORLD_TOPICS = [
  ...
  "Antiretroviral therapy: 15397, 819, 1674, 1675, 2019, 7229, 8371, 11590",
  "Arbovirus: 15491",
  "Asbestos & arsenic poisoning: 841, 553, 649",
  "Asthma: 663, 1523, 15156",
  "BCL-2: 15821",
  "Beta blockers: 1836, 1444, 692, 2000, 8289",
  "Bladder cancer: 336, 7623, 15186",
  "Bone tumor: 15635, 15645",
  "Brain tumors: 880",
  ...
  "Non-Hodgkin lymphoma: 1627, 1628, 1754, 1758, 1911",
  ...
  "Thyroid cancer: 1658, 1660, 17236",
  "Timolol: 1363",
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8 space-y-8">
      ...
      >
        ...
        <div className="pt-3 border-t border-slate-200">
          ...
          <p className="text-xs text-slate-500 mb-2">
            148 topics, 350 questions. Use this when you miss something and want every question on that subject —
            not as a to-do list.
          </p>
