...
const NAV_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "ib3", label: "IB3 — Bacteria, Antibiotics, Antifungals, Mycology", path: "#/block/ib3", status: "ready" },
      { id: "ib4", label: "IB4 — Viruses, Antivirals, Autonomics, Neoplasia", path: "#/block/ib4", status: "ready" },
